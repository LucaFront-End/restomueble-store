...
export default function NosotrosClient({ marcas }: NosotrosClientProps) {
    ...
    return (
        <main className="bg-white min-h-screen">
            ...
            <SectionHero
                ...
                backgroundImage="/images/nosotros-7.jpeg"
            />
            ...
            {/* Clientes / Logos — uses CMS data passed from server page */}
            <div className="bg-white py-24 border-t border-gray-100">
                <LogoCarousel marcas={marcas} />
            </div>
